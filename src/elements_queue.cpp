 ...
 * pop
 *
 * It uses a mutex to be thread-safe
 */
std::string*	Elements_Queue::pop() {
	std::string*	result;
	...
	result->assign(this->queue.front());
 ...
 * It uses a mutex to be thread-safe
 */
void	Elements_Queue::push(const char* file) {
